...
python improved_alpha_submitter.py --use-hopeful-file --min-hopeful-count 50 --interval-hours 24 --batch-size 10 --log-level INFO &
...
echo "Will generate 100 alpha ideas per cycle, then simulate in batches of 10..."
python alpha_orchestrator.py --ollama-url http://localhost:11434 --ollama-model $MODEL_NAME --mode continuous --mining-interval 6 --batch-size 10 --max-concurrent 5
